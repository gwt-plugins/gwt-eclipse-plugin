 ...
 * {@link GssResourceAwareTokenizer} returns "@media" for these custom at-rules
...
public class GssResourceAwareModelRepairer {
  ...
  public GssResourceAwareModelRepairer(IStructuredDocument structuredDocument,
      ICSSModel cssModel) {
