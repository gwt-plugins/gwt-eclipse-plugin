...
/**
 * Generates marker resolutions for markers of type {@link GWTProjectValidator#PROBLEM_MARKER_ID}.
 * 
 * To differentiate between the different types of problems, each marker of the given type has a
 * problem id stored in the {@link MarkerUtilities#PROBLEM_TYPE_ID} attribute of marker. The problem
 * id is stored as the string which is returned by the getId() method on the
 * {@link org.eclipse.core.resources.IMarker#getId} values.
 * 
 * Additional data specific to the problem is stored in the
 * {@link MarkerUtilities#PROBLEM_TYPE_DATA} attribute of the marker. Not every problem requires
 * additional data.
 */
public class GWTValidatorMarkerResolutionGenerator implements IMarkerResolutionGenerator {
  ...
  public IMarkerResolution[] getResolutions(IMarker marker) {
    ...
    switch (sdkProblemType) {
      ...
      case SDK_LIBRARY_MISSING_FROM_WEBINF_LIB: {
         ...
         * GaeValidatorProblemMarkerResolutionGenerator. See if there is an elegant refactoring that
         * can be done.
         */
