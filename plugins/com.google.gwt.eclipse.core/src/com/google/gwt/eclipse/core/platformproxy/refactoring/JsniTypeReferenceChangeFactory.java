...
import com.google.gwt.eclipse.core.refactoring.JsniTypeReferenceChange;
 ...
 */
public class JsniTypeReferenceChangeFactory implements
    IRefactoringChangeFactory {

  private final GWTTypeRefactoringSupport refactoringSupport;

  public JsniTypeReferenceChangeFactory(
      GWTTypeRefactoringSupport refactoringSupport) {
   ...
   */
  public IJsniTypeReferenceChange createChange(ICompilationUnit cu) {
    return new JsniTypeReferenceChange(refactoringSupport, cu);
  }
