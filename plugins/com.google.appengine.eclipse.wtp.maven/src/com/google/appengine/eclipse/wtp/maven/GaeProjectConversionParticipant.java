 ...
 *
 */
public class GaeProjectConversionParticipant extends AbstractProjectConversionParticipant {
  ...
  public void convert(IProject project, Model model, IProgressMonitor monitor)
    ...
    AppEngineMavenPlugin.logInfo(
        "GaeProjectConversionParticipant.convert invoked with model " + model);
  }
