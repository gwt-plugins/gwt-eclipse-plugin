...
/**
 * Sets up GAE on the project being created.
 */
public class GaeEnablingProjectCreationParticipant implements
    IWebAppProjectCreator.Participant {
  public void updateWebAppProjectCreator(IWebAppProjectCreator creator) {
    creator.addContainerPath(GaeSdkContainer.getDefaultSdkContainerPath());
    creator.addNature(GaeNature.NATURE_ID);
  }
}
