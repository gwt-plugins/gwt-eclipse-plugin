 ...
 * up the Java Build Path dialog and gives the user the opportunity to switch
 * their project JRE.
 */
@SuppressWarnings("restriction")
public class ChooseProjectJreSystemLibraryMarkerResolution implements
    IMarkerResolution {

  public String getLabel() {
    return "Select a newer 'JRE System Library' for your project";
  }
