...
/**
 * Logging class for the GAE plugin.
 * 
 */
public class AppEngineCorePluginLog {
  ...
  public static IStatus createStatus(int severity, int code, String message,
    ...
    return new Status(severity, AppEngineCorePlugin.PLUGIN_ID, code, message,
        exception);
  }
  ...
  public static void log(IStatus status) {
    AppEngineCorePlugin.getDefault().getLog().log(status);
  }
