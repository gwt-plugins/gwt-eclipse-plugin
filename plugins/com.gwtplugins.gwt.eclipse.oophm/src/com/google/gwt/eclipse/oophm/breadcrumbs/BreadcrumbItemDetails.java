 ...
 * org.eclipse.jdt.internal.ui.javaeditor.breadcrumb.BreadcrumbItemDetails.
 * 
 * @since 3.4
 */
class BreadcrumbItemDetails {
  ...
  public BreadcrumbItemDetails(BreadcrumbItem parent, Composite parentContainer) {
    ...
    fDetailComposite.setLayoutData(new GridData(SWT.BEGINNING, SWT.CENTER,
        false, false));
    ...
    fImageComposite.setLayoutData(new GridData(SWT.BEGINNING, SWT.CENTER,
        false, false));
    ...
    fTextComposite.setLayoutData(new GridData(SWT.BEGINNING, SWT.CENTER, false,
        false));
    layout = new GridLayout(1, false);
    ...
    fTextComposite.getAccessible().addAccessibleListener(
        new AccessibleAdapter() {
          public void getName(AccessibleEvent e) {
            e.result = fElementText.getText();
          }
        });
    fImageComposite.getAccessible().addAccessibleListener(
        new AccessibleAdapter() {
          public void getName(AccessibleEvent e) {
            e.result = fElementText.getText();
          }
