 ...
 * org.eclipse.jdt.internal.ui.javaeditor.breadcrumb.BreadcrumbItem.
 * 
 * @since 3.4
 */
class BreadcrumbItem extends Item {
   ...
   * 
   * @param state <code>true</code> if it has focus, <code>false</code>
   *          otherwise
   */
   ...
   * 
   * @param isLast <code>true</code> if this is the last item,
