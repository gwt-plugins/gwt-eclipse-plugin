...
/**
 * Renames Java types referenced from JSNI blocks.
 */
public class GWTRenameTypeInJsniParticipant extends GWTRenameTypeParticipant {

  @Override
  public Change createChange(IProgressMonitor pm) throws CoreException,
      OperationCanceledException {
    GWTTypeRefactoringSupport support = getTypeRefactoringSupport();
