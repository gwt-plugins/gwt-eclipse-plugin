...
/**
 * Logging class for the GEP.
 * 
 * TODO: refactor this so that we have some sensible way to reuse
 * in the other logging classes.
 * 
 */
public class CorePluginLog {
  ...
  public static IStatus createStatus(int severity, int code, String message,
    ...
    return new Status(severity, CorePlugin.PLUGIN_ID, code, message, exception);
  }
